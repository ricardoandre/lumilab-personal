      ...
      <Card styles={{ body: { padding: 0 } }} size={screens.lg ? 'default' : 'small'}>
        <ResponsiveRows<StockRow & { key: string }>
          ...
          fields={[
            ...
            { key: 'cost', label: 'Money in', render: (r) => <Money v={r.costBasis} compact /> },
            { key: 'unr', label: 'Unrealised', render: (r) => <Money v={r.unrealized} compact /> },
            { key: 'div', label: 'Dividends', render: (r) => <Money v={r.dividends} zeroDim compact /> },
